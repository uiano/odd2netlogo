...
<model ref="r:f1fd7b48-88e8-46fd-bb28-7929a4d0824d(formalodd.sandbox)">
  ...
  <registry>
    <language id="32c6af6f-c921-41d7-a19e-61a23bec1a47" name="formalodd">
      ...
      <concept id="3840659476812055972" name="formalodd.structure.EnvironmentEntity" flags="ng" index="ZOwrm">
        <property id="6955527831106468148" name="Color" index="2YXOq1" />
        <property id="6955527831106468151" name="ChangeNeighbors" index="2YXOq2" />
        <property id="6955527831106468146" name="Distribution" index="2YXOq7" />
        <property id="6955527831106468155" name="ChangeSelf" index="2YXOqe" />
      </concept>
      <concept id="3840659476812055959" name="formalodd.structure.Environment" flags="ng" index="ZOwr_">
        <property id="6955527831106107312" name="BackGround" index="2YUGw5" />
        <property id="6955527831106107300" name="PixelSize" index="2YUGwh" />
        <property id="6955527831106107303" name="WrapHorizontal" index="2YUGwi" />
        <property id="6955527831106107298" name="WorldSize" index="2YUGwn" />
        <property id="6955527831106107307" name="WrapVertical" index="2YUGwu" />
  ...
  <node concept="ZOwpP" id="3mweh__vi9g">
    ...
    <node concept="ZOwpU" id="3mweh__vi9h" role="3$p12O">
      ...
      <node concept="ZOwpW" id="626ZVnusRtA" role="ZOwpT">
        <property role="1gPB68" value="red" />
      </node>
      <node concept="ZOwr_" id="3mweh__vi9l" role="ZOwpV">
        <property role="2YUGwn" value="100" />
        <property role="2YUGwh" value="2" />
        <property role="2YUGwi" value="1" />
        <property role="2YUGwu" value="1" />
        <property role="2YUGw5" value="white" />
        <node concept="ZOwrm" id="626ZVnuurpA" role="2JZWw_">
          <property role="TrG5h" value="fire" />
          <property role="2YXOq7" value="left" />
          <property role="2YXOq1" value="red" />
          <property role="2YXOq2" value="green" />
          <property role="2YXOqe" value="red - 3.5" />
        </node>
        <node concept="ZOwrm" id="626ZVnuurpC" role="2JZWw_">
          <property role="TrG5h" value="trees" />
          <property role="2YXOq7" value="random" />
          <property role="2YXOq1" value="green" />
        </node>
      </node>
    </node>
  </node>
