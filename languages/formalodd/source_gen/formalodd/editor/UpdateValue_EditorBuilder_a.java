...
/*package*/ class UpdateValue_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new UpdateValue_EditorBuilder_a.ifconditionSingleRoleHandler_2yquaa_a0(myNode, MetaAdapterFactory.getContainmentLink(0x32c6af6fc92141d7L, 0xa19e61a23bec1a47L, 0x35a039196620dc12L, 0x5a9db026f74ab669L, "ifcondition"), getEditorContext());
    return provider.createCell();
  }
  private static class ifconditionSingleRoleHandler_2yquaa_a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public ifconditionSingleRoleHandler_2yquaa_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "will have value");
