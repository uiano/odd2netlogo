...
/*package*/ class EnviromentAttribute_ComponentBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public EnviromentAttribute_ComponentBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_9qvr7m_a");
    editorCell.addEditorCell(createCollection_1());
    if (nodeCondition_9qvr7m_a1a()) {
      editorCell.addEditorCell(createConstant_2());
    }
    if (nodeCondition_9qvr7m_a2a()) {
      editorCell.addEditorCell(createConstant_3());
    }
    if (nodeCondition_9qvr7m_a3a()) {
      editorCell.addEditorCell(createConstant_4());
    }
    if (nodeCondition_9qvr7m_a4a()) {
      editorCell.addEditorCell(createConstant_5());
    }
    if (nodeCondition_9qvr7m_a5a()) {
      editorCell.addEditorCell(createConstant_6());
    }
    return editorCell;
  }
  private boolean nodeCondition_9qvr7m_a1a() {
  ...
  private boolean nodeCondition_9qvr7m_a2a() {
    return SPropertyOperations.hasValue(myNode, MetaAdapterFactory.getProperty(0x32c6af6fc92141d7L, 0xa19e61a23bec1a47L, 0x354cc3720a9ec5a4L, 0x36f982e7b7a0f5baL, "showAttributes"), "does");
  }
  private boolean nodeCondition_9qvr7m_a3a() {
    return SPropertyOperations.hasValue(myNode, MetaAdapterFactory.getProperty(0x32c6af6fc92141d7L, 0xa19e61a23bec1a47L, 0x354cc3720a9ec5a4L, 0x36f982e7b7a0f5baL, "showAttributes"), "does");
  }
  private boolean nodeCondition_9qvr7m_a4a() {
    return SPropertyOperations.hasValue(myNode, MetaAdapterFactory.getProperty(0x32c6af6fc92141d7L, 0xa19e61a23bec1a47L, 0x354cc3720a9ec5a4L, 0x36f982e7b7a0f5baL, "showAttributes"), "does");
  }
  private boolean nodeCondition_9qvr7m_a5a() {
    return SPropertyOperations.hasValue(myNode, MetaAdapterFactory.getProperty(0x32c6af6fc92141d7L, 0xa19e61a23bec1a47L, 0x354cc3720a9ec5a4L, 0x36f982e7b7a0f5baL, "showAttributes"), "does");
  }
  private EditorCell createCollection_1() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_9qvr7m_a0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
    editorCell.addEditorCell(createProperty_0());
    editorCell.addEditorCell(createProperty_1());
    if (nodeCondition_9qvr7m_a2a0()) {
      editorCell.addEditorCell(createConstant_0());
    }
    if (nodeCondition_9qvr7m_a3a0()) {
      editorCell.addEditorCell(createConstant_1());
    }
    return editorCell;
  }
  private boolean nodeCondition_9qvr7m_a2a0() {
  ...
  private boolean nodeCondition_9qvr7m_a3a0() {
    return SPropertyOperations.hasValue(myNode, MetaAdapterFactory.getProperty(0x32c6af6fc92141d7L, 0xa19e61a23bec1a47L, 0x354cc3720a9ec5a4L, 0x36f982e7b7a0f5baL, "showAttributes"), "does");
  }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_9qvr7m_c0a");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_9qvr7m_d0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.FONT_STYLE, MPSFonts.PLAIN);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_9qvr7m_b0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.FONT_STYLE, MPSFonts.PLAIN);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createConstant_3() {
    ...
    editorCell.setCellId("Constant_9qvr7m_c0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.FONT_STYLE, MPSFonts.PLAIN);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createConstant_4() {
    ...
    editorCell.setCellId("Constant_9qvr7m_d0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.FONT_STYLE, MPSFonts.PLAIN);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createConstant_5() {
    ...
    editorCell.setCellId("Constant_9qvr7m_e0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.FONT_STYLE, MPSFonts.PLAIN);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createConstant_6() {
    ...
    editorCell.setCellId("Constant_9qvr7m_f0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.FONT_STYLE, MPSFonts.PLAIN);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
