...
/*package*/ class KillEntity_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new KillEntity_EditorBuilder_a.ifconditionSingleRoleHandler_zfs2md_a0(myNode, MetaAdapterFactory.getContainmentLink(0x32c6af6fc92141d7L, 0xa19e61a23bec1a47L, 0x35a039196620dc12L, 0x5a9db026f74ab669L, "ifcondition"), getEditorContext());
    return provider.createCell();
  }
  private static class ifconditionSingleRoleHandler_zfs2md_a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public ifconditionSingleRoleHandler_zfs2md_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
