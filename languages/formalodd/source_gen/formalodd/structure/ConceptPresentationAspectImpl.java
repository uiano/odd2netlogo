...
public class ConceptPresentationAspectImpl extends ConceptPresentationAspectBase {
  ...
  private ConceptPresentation props_EnvironmentAttribute;
  private ConceptPresentation props_EnvironmentColor;
  private ConceptPresentation props_EnvironmentColorShade;
  private ConceptPresentation props_EnvironmentConditionalColor;
  ...
  public ConceptPresentation getDescriptor(SAbstractConcept c) {
    ...
    switch (structureDescriptor.internalIndex(c)) {
      ...
      case LanguageConceptSwitch.Count:
        if (props_Count == null) {
          ConceptPresentationBuilder cpb = new ConceptPresentationBuilder();
          cpb.presentationByReference(0x32c6af6fc92141d7L, 0xa19e61a23bec1a47L, 0x354cc3720a9ec55dL, 0x354cc3720a9ec55eL, "entity", "", "");
      ...
      case LanguageConceptSwitch.EnvironmentAttribute:
        if (props_EnvironmentAttribute == null) {
          ConceptPresentationBuilder cpb = new ConceptPresentationBuilder();
          ...
          cpb.presentationByName();
          props_EnvironmentAttribute = cpb.create();
        }
        return props_EnvironmentAttribute;
      case LanguageConceptSwitch.EnvironmentColor:
        if (props_EnvironmentColor == null) {
          ConceptPresentationBuilder cpb = new ConceptPresentationBuilder();
          cpb.presentationByName();
          props_EnvironmentColor = cpb.create();
        }
        return props_EnvironmentColor;
      case LanguageConceptSwitch.EnvironmentColorShade:
        if (props_EnvironmentColorShade == null) {
          ConceptPresentationBuilder cpb = new ConceptPresentationBuilder();
          cpb.presentationByName();
          props_EnvironmentColorShade = cpb.create();
        }
        return props_EnvironmentColorShade;
      case LanguageConceptSwitch.EnvironmentConditionalColor:
        if (props_EnvironmentConditionalColor == null) {
          ConceptPresentationBuilder cpb = new ConceptPresentationBuilder();
          cpb.rawPresentation("EnvironmentConditionalColor");
          props_EnvironmentConditionalColor = cpb.create();
        }
        return props_EnvironmentConditionalColor;
